...
public class Get07 extends JsonplaceholderBaseUrl {
    ...
    public void get01() {
        ...
        assertEquals("Id 190'dan buyuk olanlar eslemedi",10,ids.size());

        // 3)Print all userIds whose ids are less than 5 on the console
        List<Integer> userIds = json.getList("findAll{it.id<5}.userId");
        System.out.println("Id'si 5'ten kucuk olanlar : " + userIds);
        // Assert that the number of userIds whose ids are less than 5 is 4
        assertEquals("Id'si 5 den kucuk olan tum useridler",4,userIds.size());
