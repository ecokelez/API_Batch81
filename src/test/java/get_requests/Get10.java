...
import post_requests.test_data.GoRestTestData;
...
public class Get10 extends GoRestBaseUrl {
    ...
    public void get10() {
       ...
       Map<String,String> dataKeyMap = obj.dataKeyMapMethod("Agnivesh Dubashi","dubashi_agnivesh@smitham-weber.biz","male","inactive");
